 ...
 * C source code generated on : Tue Jan 28 15:27:11 2020
 *
...
void helicopter_output(void)
{
  ...
  /* Step: '<Root>/Step2' */
  if (helicopter_M->Timing.t[0] < helicopter_P.Step2_Time) {
    rtb_Derivative = helicopter_P.Step2_Y0;
  } else {
    rtb_Derivative = helicopter_P.Step2_YFinal;
  }
  ...
  if (helicopter_M->Timing.t[0] < helicopter_P.Step_Time) {
    tmp = helicopter_P.Step_Y0;
  } else {
    tmp = helicopter_P.Step_YFinal;
  }

  /* End of Step: '<Root>/Step' */

  /* Sum: '<Root>/Sum3' */
  helicopter_B.Sum3 = rtb_Derivative + tmp;

  /* Step: '<Root>/Step1' */
  if (helicopter_M->Timing.t[0] < helicopter_P.Step1_Time) {
    rtb_Derivative = helicopter_P.Step1_Y0;
  } else {
    rtb_Derivative = helicopter_P.Step1_YFinal;
  }

  /* End of Step: '<Root>/Step1' */

  /* Step: '<Root>/Step3' */
  if (helicopter_M->Timing.t[0] < helicopter_P.Step3_Time) {
    tmp = helicopter_P.Step3_Y0;
  } else {
    tmp = helicopter_P.Step3_YFinal;
  }

  /* End of Step: '<Root>/Step3' */

  /* Sum: '<Root>/Sum4' */
  helicopter_B.Sum4 = rtb_Derivative + tmp;
  if (rtmIsMajorTimeStep(helicopter_M)) {
  ...
  if (rtmIsMajorTimeStep(helicopter_M)) {
    ...
    rtb_TmpSignalConversionAtToFile[1] = helicopter_B.Sum4;
    rtb_TmpSignalConversionAtToFile[2] = helicopter_B.Gain1[2];
    rtb_TmpSignalConversionAtToFile[3] = helicopter_B.Gain1[4];

    /* ToFile: '<Root>/To File' */
    {
      if (!(++helicopter_DW.ToFile_IWORK.Decimation % 1) &&
          (helicopter_DW.ToFile_IWORK.Count*5)+1 < 100000000 ) {
        ...
        if (fp != (NULL)) {
          ...
          if (fwrite(u, sizeof(real_T), 5, fp) != 5) {
            rtmSetErrorStatus(helicopter_M,
                              "Error writing to MAT-file assignment1_reg_test.mat");
            return;
          }

          if (((++helicopter_DW.ToFile_IWORK.Count)*5)+1 >= 100000000) {
            (void)fprintf(stdout,
                          "*** The ToFile block will stop logging data before\n"
                          "    the simulation has ended, because it has reached\n"
                          "    the maximum number of elements (100000000)\n"
                          "    allowed in MAT-file assignment1_reg_test.mat.\n");
          }
        }
      }
    }
   ...
   *  Sum: '<S5>/Sum3'
   */
  helicopter_B.Sum1 = ((helicopter_B.Sum3 - helicopter_B.Gain1[2]) *
  ...
  /* Sum: '<S3>/Sum' */
  rtb_Derivative = helicopter_B.Sum4 - helicopter_B.Gain1[4];
   ...
   *  Sum: '<S1>/Subtract'
   */
  rtb_Derivative = (helicopter_B.Sum2 - helicopter_B.Sum1) *
   ...
   *  Sum: '<S1>/Add'
   */
  rtb_Derivative = (helicopter_B.Sum1 + helicopter_B.Sum2) *
...
void helicopter_initialize(void)
{
  ...
  {
    FILE *fp = (NULL);
    char fileName[509] = "assignment1_reg_test.mat";
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(helicopter_M,
                        "Error creating .mat file assignment1_reg_test.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,5,0,"ans")) {
      rtmSetErrorStatus(helicopter_M,
                        "Error writing mat file header to file assignment1_reg_test.mat");
      return;
    }
...
void helicopter_terminate(void)
{
  ...
  /* Terminate for ToFile: '<Root>/To File' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(helicopter_M,
                          "Error closing MAT-file assignment1_reg_test.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(helicopter_M,
                          "Error reopening MAT-file assignment1_reg_test.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 5, helicopter_DW.ToFile_IWORK.Count, "ans"))
      {
        rtmSetErrorStatus(helicopter_M,
                          "Error writing header for ans to MAT-file assignment1_reg_test.mat");
      }
...
RT_MODEL_helicopter_T *helicopter(void)
{
  ...
  /* External mode info */
  helicopter_M->Sizes.checksums[0] = (2146756928U);
  helicopter_M->Sizes.checksums[1] = (1170804070U);
  helicopter_M->Sizes.checksums[2] = (4195769867U);
  helicopter_M->Sizes.checksums[3] = (717521911U);
