 ...
 * C source code generated on : Tue Feb 04 14:25:22 2020
 *
...
void helicopter_output(void)
{
   ...
   *  Sum: '<S5>/Sum3'
   */
  helicopter_B.Sum1 = ((0.0 - helicopter_P.Gain1_Gain * helicopter_B.Gain_i) *
...
RT_MODEL_helicopter_T *helicopter(void)
{
  ...
  /* External mode info */
  helicopter_M->Sizes.checksums[0] = (534024036U);
  helicopter_M->Sizes.checksums[1] = (1841179477U);
  helicopter_M->Sizes.checksums[2] = (655521008U);
  helicopter_M->Sizes.checksums[3] = (1762537664U);
