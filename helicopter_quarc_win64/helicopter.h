...
struct P_helicopter_T_ {
  ...
  boolean_T HILInitialize_set_pwm_params__f;/* Mask Parameter: HILInitialize_set_pwm_params__f
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  real_T Step2_Time;                   /* Expression: 7
                                        * Referenced by: '<Root>/Step2'
                                        */
  real_T Step2_Y0;                     /* Expression: 0
                                        * Referenced by: '<Root>/Step2'
                                        */
  real_T Step2_YFinal;                 /* Expression: 60/180*pi
                                        * Referenced by: '<Root>/Step2'
                                        */
  real_T Step_Time;                    /* Expression: 8
                                        * Referenced by: '<Root>/Step'
                                        */
  real_T Step_Y0;                      /* Expression: 0
                                        * Referenced by: '<Root>/Step'
                                        */
  real_T Step_YFinal;                  /* Expression: -60/180*pi
                                        * Referenced by: '<Root>/Step'
                                        */
  ...
  real_T Step1_Y0;                     /* Expression: 0
                                        * Referenced by: '<Root>/Step1'
                                        */
  real_T Step1_YFinal;                 /* Expression: 60/180*pi
                                        * Referenced by: '<Root>/Step1'
                                        */
  real_T Step3_Time;                   /* Expression: 13
                                        * Referenced by: '<Root>/Step3'
                                        */
  real_T Step3_Y0;                     /* Expression: 0
                                        * Referenced by: '<Root>/Step3'
                                        */
  real_T Step3_YFinal;                 /* Expression: -60/180*pi
                                        * Referenced by: '<Root>/Step3'
                                        */
