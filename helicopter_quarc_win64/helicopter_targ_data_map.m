  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% helicopter_P.Step2_Time
	  section.data(1).logicalSrcIdx = 77;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_P.Step2_Y0
	  section.data(2).logicalSrcIdx = 78;
	  section.data(2).dtTransOffset = 1;
	
	  ;% helicopter_P.Step2_YFinal
  ...
  targMap.checksum0 = 2146756928;
  targMap.checksum1 = 1170804070;
  targMap.checksum2 = 4195769867;
  targMap.checksum3 = 717521911;
