...
A1 = [1, delta_t, 0,0;0,1,-K_2*delta_t,0;0,0,1,delta_t;0,0,0,-K_1*K_pp*delta_t];
...
tic
[z,lambda] = quadprog(Q, zeros(500,1), [], [], Aeq, beq, vlb, vub, x0); % hint: quadprog. Type 'doc quadprog' for more info 
t1=toc;
