...
#define Assignment_2_rtModel           RT_MODEL_Assignment_2_T
...
#define rtB                            Assignment_2_B
#define BlockIO                        B_Assignment_2_T
#define rtX                            Assignment_2_X
#define ContinuousStates               X_Assignment_2_T
#define rtXdot                         Assignment_2_XDot
#define StateDerivatives               XDot_Assignment_2_T
#define tXdis                          Assignment_2_XDis
#define StateDisabled                  XDis_Assignment_2_T
#define rtP                            Assignment_2_P
#define Parameters                     P_Assignment_2_T
#define rtDWork                        Assignment_2_DW
#define D_Work                         DW_Assignment_2_T
...
struct P_Assignment_2_T_ {
  ...
  real_T Constant_Value;               /* Expression: 0
                                        ...
                                        */
  real_T travel_offsetrad_Value;       /* Expression: 180
                                        * Referenced by: '<Root>/travel_offset [rad]'
                                        */
  ...
  real_T Gain_Gain_l;                  /* Expression: 180/pi
                                        ...
                                        */
  real_T pitch_offsetrad1_Value;       /* Expression: 5
                                        * Referenced by: '<Root>/pitch_offset [rad]1'
                                        */
...
/* Continuous states (auto storage) */
extern X_Assignment_2_T Assignment_2_X;
...
extern void Assignment_2_output(void);
extern void Assignment_2_update(void);
extern void Assignment_2_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Assignment_2_rtModel *Assignment_2(void);
 ...
 *
 * '<Root>' : 'Assignment_2'
 * '<S1>'   : 'Assignment_2/Conversion'
 * '<S2>'   : 'Assignment_2/Degrees to Radians'
 * '<S3>'   : 'Assignment_2/Elevation controller'
 * '<S4>'   : 'Assignment_2/Helicopter_interface'
 * '<S5>'   : 'Assignment_2/Pitch controller'
 * '<S6>'   : 'Assignment_2/Helicopter_interface/Elevation rad to deg'
 * '<S7>'   : 'Assignment_2/Helicopter_interface/Elevation rate rad to deg'
 * '<S8>'   : 'Assignment_2/Helicopter_interface/Pitch rad to deg'
 * '<S9>'   : 'Assignment_2/Helicopter_interface/Pitch rate rad to deg'
 * '<S10>'  : 'Assignment_2/Helicopter_interface/Pitch rate rad to deg1'
 * '<S11>'  : 'Assignment_2/Helicopter_interface/Travel rad to deg'
 * '<S12>'  : 'Assignment_2/Helicopter_interface/Travel rate  rad to deg'
 */
